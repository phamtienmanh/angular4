...
@Component({
  selector: 'neck-print-sample',
  encapsulation: ViewEncapsulation.None,
  templateUrl: 'neck-print-sample.template.html',
  styleUrls: [
    // neck-print-sample.styles.scss'
  ]
})
export class NeckPrintSampleComponent implements OnInit {
  @Input()
  public orderId;
  @Input()
  ...
  constructor(public activeModal: NgbActiveModal,
              ...
              private _neckPrintSampleService: NeckPrintSampleService,
  ...
  public getCommonData(): void {
    this._neckPrintSampleService.getDataColumn(this.orderId, this.orderDetailId)
  ...
  public onSubmitForm(): void {
    if (this.checkFormValid() && this.leadEtaComponent.checkFormValid()) {
      ...
      this._neckPrintSampleService.changeStatusColumn(this.orderId, this.orderDetailId, modal)
        .subscribe((resp: ResponseMessage<any>) => {
          if (resp.status) {
