...
@Component({
  ...
  templateUrl: 'photo-approval.template.html',
  styleUrls: [
    // 'photo-approval.styles.scss'
  ]
})
export class PhotoApprovalComponent implements OnInit {
  ...
  constructor(public activeModal: NgbActiveModal,
              ...
              private _photoApprovalService: PhotoApprovalService,
  ...
  public buildForm(): void {
    let controlConfig = {
      ...
      approvedToSampleStatus: new FormControl(null),
      approvedToSampleComment: new FormControl(''),
      approvedToSampleDate: new FormControl(''),
      approvedToSampleDateOnUtc: new FormControl('',
        Validators.compose([
          ExtraValidators.conditional(
            (group) => this.getSpecialRequireCase(group, 'approvedToSampleDateOnUtc'),
            Validators.required
          ),
      ...
      formRequires: new FormControl({
        approvedToSampleStatus: {
          required: false
        },
        approvedToSampleComment: {
          required: false
        },
        approvedToSampleDateOnUtc: {
          required: false
  ...
  public getSpecialRequireCase(frm: FormGroup, key: string): boolean {
    if (key === 'approvedToSampleDateOnUtc') {
      let isRequired = [
        this.taskStatus.APPROVED
      ].indexOf(+this.frm.get('approvedToSampleStatus').value) > -1;
  ...
  public getCommonData(): void {
    this._photoApprovalService.getDataColumn(this.orderId, this.orderDetailId,
  ...
  public onSubmitForm(): void {
    if (this.checkFormValid() && this.leadEtaComponent.checkFormValid()) {
      ...
      this._photoApprovalService.changeStatusColumn(this.orderId, this.orderDetailId,
