...
@Component({
  selector: 'phys-sample-approved',
  encapsulation: ViewEncapsulation.None,
  templateUrl: 'phys-sample-approved.template.html',
  styleUrls: [
    // 'phys-sample-approved.style.scss'
  ]
})
export class PhysSampleApprovedComponent implements OnInit {
  @Input()
  public orderId;
  @Input()
  ...
  constructor(public activeModal: NgbActiveModal,
              ...
              private _physSampleApprovedService: PhysSampleApprovedService,
  ...
  public buildForm(): void {
    let controlConfig = {
      ...
      physSampleApprovedByTestingFacilityPpStatus: new FormControl(null),
      physSampleApprovedByTestingFacilityPp: new FormControl(''),
      ...
      formRequires: new FormControl({
        physSampleApprovedByTestingFacilityPpStatus: {
          required: false
        },
        physSampleApprovedByTestingFacilityPpOnUtc: {
          required: false
  ...
  public getSpecialRequireCase(frm: FormGroup, key: string): boolean {
    if (key === 'physSampleApprovedByTestingFacilityPpOnUtc') {
      let isRequired = [
        this.taskStatus.DONE
      ].indexOf(+this.frm.get('physSampleApprovedByTestingFacilityPpStatus').value) > -1;
  ...
  public getCommonData(): void {
    if (this.projectId && this.productId) {
      this._physSampleApprovedService
        .getDataProjectColumn(this.projectId, this.productId, ColumnType.PhysSampleApproved)
      ...
      this._physSampleApprovedService.getDataColumn(this.orderId, this.orderDetailId, this.type)
        .subscribe((resp: ResponseMessage<any>) => {
          if (resp.status) {
            this.updateForm(resp.data);
            this._storedData = resp.data;
      ...
      if (this.projectId && this.productId) {
        this._physSampleApprovedService
          .changeStatusProjectColumn(this.projectId, this.productId,
            ColumnType.PhysSampleApproved, modal)
          .subscribe((resp: ResponseMessage<any>) => {
            if (resp.status) {
