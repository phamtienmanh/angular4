...
export class FinalApprovalService {
  ...
  public getDataProjectColumn(projectId: number,
    ...
    return this.http
      .get(`/api/v1/projects/${projectId}/products/${
        productId}/column/printlocation/${printLocationId}`);
  }
  ...
  public changeStatusProjectColumn(projectId: number,
                                   ...
                                   model: any): Observable<ResponseMessage<any>> {
    return this.http
      .put(`/api/v1/projects/${projectId}/products/${
        productId}/column/printlocation/${printLocationId}`, model);
  }
}
