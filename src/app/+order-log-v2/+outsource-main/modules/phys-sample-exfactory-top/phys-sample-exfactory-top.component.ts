...
@Component({
  selector: 'phys-sample-exfactory-top',
  encapsulation: ViewEncapsulation.None,
  templateUrl: 'phys-sample-exfactory-top.template.html',
  styleUrls: [
    // 'phys-sample-exfactory-top.style.scss'
  ]
})
export class PhysSampleExfactoryTopComponent implements OnInit {
  @Input()
  public orderId;
  @Input()
  ...
  public formErrors = {
    physSampleExFactoryDateCarrierId: '',
    physSampleExFactoryDateTracking: '',
  ...
  constructor(public activeModal: NgbActiveModal,
              ...
              private _physSampleExfactoryTopService: PhysSampleExfactoryTopService,
  ...
  public buildForm(): void {
    let controlConfig = {
      ...
      physSampleExFactoryDateStatus: new FormControl(null),
      physSampleExFactoryDateCarrierId: new FormControl(null, Validators.compose([
      ...
      physSampleExFactoryDateTracking: new FormControl('', Validators.compose([
          ExtraValidators.conditional(
            (group) => this.getSpecialRequireCase(group, 'firstCase'),
            Validators.required
          )
  ...
  public getSpecialRequireCase(frm: FormGroup, key: string): boolean {
    if (key === 'firstCase') {
      ...
      ].indexOf(+this.frm.get('physSampleExFactoryDateStatus').value) > -1;
  ...
  public getCommonData(): void {
    ...
    this._physSampleExfactoryTopService.getDataColumn(this.orderId, this.orderDetailId, this.type)
      .subscribe((resp: ResponseMessage<any>) => {
        if (resp.status) {
  ...
  public onSubmitForm(): void {
    if (this.checkFormValid() && this.leadEtaComponent.checkFormValid()) {
      ...
      this._physSampleExfactoryTopService
