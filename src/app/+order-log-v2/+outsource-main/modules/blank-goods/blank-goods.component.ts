  ...
  public onSubmitForm(): void {
    if (this.checkFormValid()) {
      ...
      const modal = Object.assign({
          columnId: this.frm.value.columnId,
          listUpdateBlankGoodsEta: this.frm.value.blankGoods,
        // ...this.leadEtaComponent.getFormValue()
      });
      delete modal['formRequires'];
      this._blankGoodsService.changeStatusColumn(this.orderId, this.styleId, modal)
        .subscribe((resp: ResponseMessage<any>) => {
          if (resp.status) {
