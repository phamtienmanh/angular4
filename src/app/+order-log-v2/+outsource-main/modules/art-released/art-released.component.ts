...
export class ArtReleasedComponent implements OnInit {
  ...
  constructor(public activeModal: NgbActiveModal,
              ...
              private _artReleasedService: ArtReleasedService,
  ...
  public buildForm(): void {
    let controlConfig = {
      ...
      artReleasedStatus: new FormControl(null),
  ...
  public getSpecialRequireCase(frm: FormGroup, key: string): boolean {
    if (key === 'artReleasedDateOnUtc') {
      ...
      ].indexOf(+this.frm.get('artReleasedStatus').value) > -1;
  ...
  public getCommonData(): void {
    this._artReleasedService.getDataColumn(this.orderId, this.orderDetailId,
  ...
  public onSubmitForm(): void {
    if (this.checkFormValid() && this.leadEtaComponent.checkFormValid()) {
      ...
      this._artReleasedService.changeStatusColumn(this.orderId, this.orderDetailId,
