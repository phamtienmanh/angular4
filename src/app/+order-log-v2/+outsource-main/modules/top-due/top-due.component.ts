...
@Component({
  ...
  templateUrl: 'top-due.template.html',
  styleUrls: [
    // 'top-due.style.scss'
  ]
})
export class TopDueComponent implements OnInit {
  @Input()
  public orderId;
  @Input()
  ...
  constructor(public activeModal: NgbActiveModal,
              ...
              private _topDueService: TopDueService,
  ...
  public buildForm(): void {
    let controlConfig = {
      ...
      dueDateStatus: new FormControl(null),
      dueDate: new FormControl(''),
      dueDateOnUtc: new FormControl('', [
        Validators.compose([
          ExtraValidators.conditional(
            (group) => this.getSpecialRequireCase(group, 'dueDateOnUtc'),
            Validators.required
          ),
  ...
  public getSpecialRequireCase(frm: FormGroup, key: string): boolean {
    if (key === 'dueDateOnUtc') {
      ...
      ].indexOf(+this.frm.get('dueDateStatus').value) > -1;
  ...
  public getCommonData(): void {
    this._topDueService.getDataColumn(this.orderId, this.orderDetailId, this.type)
