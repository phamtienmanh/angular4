...
@Component({
  selector: 'neck-label-photo',
  encapsulation: ViewEncapsulation.None,
  templateUrl: 'neck-label-photo.template.html',
  styleUrls: [
    // 'neck-label-photo.style.scss'
  ]
})
export class NeckLabelPhotoComponent implements OnInit {
  @Input()
  public orderId;
  @Input()
  ...
  constructor(public activeModal: NgbActiveModal,
              ...
              private _neckLabelPhotoService: NeckLabelPhotoService,
  ...
  public buildForm(): void {
    let controlConfig = {
      ...
      artApprovedDateStatus: new FormControl(null),
      artApprovedDateComment: new FormControl(''),
      artApprovedDate: new FormControl(''),
      artApprovedDateOnUtc: new FormControl('', [
        Validators.compose([
          ExtraValidators.conditional(
            (group) => this.getSpecialRequireCase(group, 'artApprovedDateOnUtc'),
            Validators.required
          ),
      ...
      formRequires: new FormControl({
        artApprovedDateStatus: {
          required: false
        },
        artApprovedDateComment: {
          required: false
        },
        artApprovedDateOnUtc: {
          required: false
  ...
  public getSpecialRequireCase(frm: FormGroup, key: string): boolean {
    if (key === 'artApprovedDateOnUtc') {
      let isRequired = [
        this.taskStatus.APPROVED
      ].indexOf(+this.frm.get('artApprovedDateStatus').value) > -1;
  ...
  public getCommonData(): void {
    this._neckLabelPhotoService.getDataColumn(this.orderId, this.orderDetailId)
  ...
  public onSubmitForm(): void {
    if (this.checkFormValid() && this.leadEtaComponent.checkFormValid()) {
      ...
      this._neckLabelPhotoService.changeStatusColumn(this.orderId, this.orderDetailId, modal)
        .subscribe((resp: ResponseMessage<any>) => {
          if (resp.status) {
