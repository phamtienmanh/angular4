...
@Component({
  selector: 'treatment-sample',
  encapsulation: ViewEncapsulation.None,
  templateUrl: 'treatment-sample.template.html',
  styleUrls: [
    // 'treatment-sample.styles.scss'
  ]
})
export class TreatmentSampleComponent implements OnInit {
  @Input()
  public orderId;
  @Input()
  ...
  constructor(public activeModal: NgbActiveModal,
              ...
              private _treatmentSampleService: TreatmentSampleService,
  ...
  public buildForm(): void {
    let controlConfig = {
      ...
      treatmentSampleDateStatus: new FormControl(null),
      treatmentSampleDateComment: new FormControl(''),
      treatmentSampleDate: new FormControl(''),
      treatmentSampleDateOnUtc: new FormControl('',
        Validators.compose([
          ExtraValidators.conditional(
            (group) => this.getSpecialRequireCase(group, 'treatmentSampleDateOnUtc'),
            Validators.required
          ),
      ...
      formRequires: new FormControl({
        treatmentSampleDateStatus: {
          required: false
        },
        treatmentSampleDateComment: {
          required: false
        },
        treatmentSampleDateOnUtc: {
          required: false
  ...
  public getSpecialRequireCase(frm: FormGroup, key: string): boolean {
    if (key === 'treatmentSampleDateOnUtc') {
      let isRequired = [
        this.taskStatus.APPROVED
      ].indexOf(+this.frm.get('treatmentSampleDateStatus').value) > -1;
  ...
  public getCommonData(): void {
    this._treatmentSampleService.getDataColumn(this.orderId, this.orderDetailId)
  ...
  public onSubmitForm(): void {
    if (this.checkFormValid() && this.leadEtaComponent.checkFormValid()) {
      ...
      this._treatmentSampleService.changeStatusColumn(this.orderId, this.orderDetailId, modal)
        .subscribe((resp: ResponseMessage<any>) => {
          if (resp.status) {
