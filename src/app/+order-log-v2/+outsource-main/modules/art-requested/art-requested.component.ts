...
@Component({
  selector: 'art-requested',
  encapsulation: ViewEncapsulation.None,
  templateUrl: 'art-requested.template.html',
  styleUrls: [
    // 'art-requested.styles.scss'
  ]
})
export class ArtRequestedComponent implements OnInit {
  @Input()
  public orderId;
  @Input()
  ...
  constructor(public activeModal: NgbActiveModal,
              ...
              private _artRequestedService: ArtRequestedService,
  ...
  public buildForm(): void {
    let controlConfig = {
      ...
      artRequestedStatus: new FormControl(null),
      artRequested: new FormControl(''),
      artRequestedOnUtc: new FormControl('',
        Validators.compose([
          ExtraValidators.conditional(
            (group) => this.getSpecialRequireCase(group, 'artRequestedOnUtc'),
            Validators.required
          ),
  ...
  public getSpecialRequireCase(frm: FormGroup, key: string): boolean {
    if (key === 'artRequestedOnUtc') {
      let isRequired = [
        this.taskStatus.DONE
      ].indexOf(+this.frm.get('artRequestedStatus').value) > -1;
  ...
  public getCommonData(): void {
    this._artRequestedService.getDataColumn(this.orderId, this.orderDetailId, this.type)
