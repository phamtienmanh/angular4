...
import { FilerType } from './outsource-main-filter.model';
import {
  BasicCsrInfo,
  BasicCustomerInfo
...
@Component({
  ...
  selector: 'outsource-main-filter',  // <forgot-password></forgot-password>
  // Our list of styles in our component. We may add more to compose many styles together
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
  // Every Angular template is first compiled by the browser before Angular runs it's compiler
  templateUrl: 'outsource-main-filter.template.html',
  styleUrls: [
    'outsource-main-filter.style.scss'
  ]
})
export class OutsourceMainFilterComponent implements OnInit, OnChanges, OnDestroy {
  ...
  public listColumnName = _.sortBy(ColumnsTypeOutsource, 'name');
  ...
  public ngOnInit(): void {
    ...
    // Config filter
    let filterStore = this._localStorageService.get('Outsource_FilterModel') as any;
    if (filterStore) {
      if (this.frm) {
  ...
  public getCustomerByType(): Promise<boolean> {
    return new Promise((resolve, reject) => {
      this._commonService.getCustomersListByType(this.typeTab)
  ...
  public configNavTabs(): void {
    ...
    if (this.tabs && this.tabs.length) {
      const outsourceCurrentCustomer = this._localStorageService
        .get('Outsource_CurrentCustomer') as any;
  ...
  public switchTab(index: number): void {
    ...
    this._localStorageService.set('Outsource_CurrentCustomer',
      {
  ...
  public filter(): void {
    ...
    this._localStorageService.set('Outsource_FilterModel',
      this.getFilterModel());
    this.onFilter.emit({
      keyword: this.keyword,
      filter: this.getFilterParam(),
