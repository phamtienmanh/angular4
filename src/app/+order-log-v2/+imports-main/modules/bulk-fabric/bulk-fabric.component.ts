...
@Component({
  selector: 'bulk-fabric',
  encapsulation: ViewEncapsulation.None,
  templateUrl: 'bulk-fabric.template.html',
  styleUrls: [
    // 'bulk-fabric.style.scss'
  ]
})
export class BulkFabricComponent implements OnInit {
  @Input()
  public orderId;
  @Input()
  ...
  constructor(public activeModal: NgbActiveModal,
              ...
              private _bulkFabricService: BulkFabricService,
  ...
  public buildForm(): void {
    let controlConfig = {
      ...
      bulkFabricStatus: new FormControl(null),
      bulkFabricDateCompleted: new FormControl(''),
      bulkFabricDateCompletedOnUtc: new FormControl('', [
        Validators.compose([
          ExtraValidators.conditional(
            (group) => this.getSpecialRequireCase(group, 'bulkFabricDateCompletedOnUtc'),
            Validators.required
          ),
  ...
  public getSpecialRequireCase(frm: FormGroup, key: string): boolean {
    if (key === 'bulkFabricDateCompletedOnUtc') {
      let isRequired = [
        this.taskStatus.DONE
      ].indexOf(+this.frm.get('bulkFabricStatus').value) > -1;
  ...
  public setDateValue(): void {
    ...
    patchDateFunc('bulkFabricDateCompletedOnUtc', 'bulkFabricDateCompleted');
  }
  ...
  public getCommonData(): void {
    this._bulkFabricService.getDataColumn(this.orderId, this.orderDetailId)
  ...
  public onSubmitForm(): void {
    if (this.checkFormValid() && this.leadEtaComponent.checkFormValid()) {
      ...
      this._bulkFabricService.changeStatusColumn(this.orderId, this.orderDetailId, modal)
        .subscribe((resp: ResponseMessage<any>) => {
          if (resp.status) {
