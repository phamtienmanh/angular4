...
@Component({
  selector: 'fit-sample-due',
  encapsulation: ViewEncapsulation.None,
  templateUrl: 'fit-sample-due.template.html',
  styleUrls: [
    'fit-sample-due.style.scss'
  ]
})
export class FitSampleDueComponent implements OnInit {
  @Input()
  ...
  constructor(public activeModal: NgbActiveModal,
              ...
              private _fitSampleDueService: FitSampleDueService,
