...
@Component({
  selector: 'fabric-quality-due',
  encapsulation: ViewEncapsulation.None,
  templateUrl: 'fabric-quality-due.template.html',
  styleUrls: [
    'fabric-quality-due.style.scss'
  ]
})
export class FabricQualityDueComponent implements OnInit {
  @Input()
  ...
  constructor(public activeModal: NgbActiveModal,
              ...
              private _fabricQualityDueService: FabricQualityDueService,
  ...
  public getCommonData(): void {
    ...
    this._fabricQualityDueService
      .getDataColumn(this.orderId, this.orderDetailId, this.fabricQualityId)
      .subscribe((resp: ResponseMessage<any>) => {
        if (resp.status) {
  ...
  public onSubmitForm(): void {
    if (this.checkFormValid() && this.leadEtaComponent.checkFormValid()) {
      ...
      this._fabricQualityDueService
        .changeStatusColumn(this.orderId, this.orderDetailId, this.fabricQualityId, modal)
        .subscribe((resp: ResponseMessage<any>) => {
          if (resp.status) {
