...
@Component({
  selector: 'lab-dips-due',
  encapsulation: ViewEncapsulation.None,
  templateUrl: 'lab-dips-due.template.html',
  styleUrls: [
    'lab-dips-due.style.scss'
  ]
})
export class LabDipsDueComponent implements OnInit {
  @Input()
  ...
  constructor(public activeModal: NgbActiveModal,
              ...
              private _labDipsDueService: LabDipsDueService,
  ...
  public buildForm(): void {
    let controlConfig = {
      ...
      dateReceivedOnUtc: new FormControl('', [
        Validators.compose([
          Validators.pattern('([0-9]{2})\/([0-9]{2})\/([0-9]{4})$' +
            '|^([0-9]{4})\-([0-9]{2})\-([0-9]{2})[T]([^a-z]+)')
        ])
  ...
  public setDateValue(): void {
    ...
    patchDateFunc('droppedDateOnUtc',
      'droppedDate');
    patchDateFunc('dateReceivedOnUtc',
      'dateReceived');
  }
  ...
  public getCommonData(): void {
    ...
    this._labDipsDueService
      .getDataColumn(this.orderId, this.orderDetailId, this.fabricQualityId, this.labDipId)
      .subscribe((resp: ResponseMessage<any>) => {
        if (resp.status) {
  ...
  public onSubmitForm(): void {
    if (this.checkFormValid() && this.leadEtaComponent.checkFormValid()) {
      ...
      this._labDipsDueService
        .changeStatusColumn(this.orderId, this.orderDetailId,
          this.fabricQualityId, this.labDipId, modal)
        .subscribe((resp: ResponseMessage<any>) => {
          if (resp.status) {
