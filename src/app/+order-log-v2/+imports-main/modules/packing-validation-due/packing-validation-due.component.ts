...
@Component({
  selector: 'packing-validation-due',
  encapsulation: ViewEncapsulation.None,
  templateUrl: 'packing-validation-due.template.html',
  styleUrls: [
    'packing-validation-due.style.scss'
  ]
})
export class PackingValidationDueComponent implements OnInit {
  @Input()
  public orderId;
  @Input()
  ...
  constructor(public activeModal: NgbActiveModal,
              ...
              private _packingValidationDueService: PackingValidationDueService,
  ...
  public getCommonData(): void {
    ...
    this._packingValidationDueService
