...
@Injectable()
export class LocationDetailDeactive implements CanDeactivate<LocationDetailComponent> {
  constructor(private _modalService: NgbModal,
              private _userContext: UserContext) {
    // empty
  }

  public canDeactivate(component: LocationDetailComponent,
    ...
    const preData = component.preLocationDetailData;
