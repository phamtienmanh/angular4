...
export class FactoryComponent implements OnInit,
  ...
  public buildForm(): void {
    let controlConfig = {
      ...
      topPpPoId: new FormControl(''),
      topPpCancelDate: new FormControl(''),
      topPpCancelDateOnUtc: new FormControl(''),
  ...
  public setDateValue(form: FormGroup): void {
    ...
    patchDateFunc('topPpCancelDateOnUtc', 'topPpCancelDate');
  }
