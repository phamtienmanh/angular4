...
@Injectable()
export class TrimsDetailDeactive implements CanDeactivate<TrimsDetailComponent> {
  constructor(private _modalService: NgbModal,
              private _userContext: UserContext) {
    // empty
  }

  public canDeactivate(component: TrimsDetailComponent,
    ...
    const preData = component.preTrimData;
