...
@Injectable()
export class SampleDeactive implements CanDeactivate<SampleComponent> {
  constructor(private _modalService: NgbModal,
              private _userContext: UserContext) {
    // empty
  }

  public canDeactivate(component: SampleComponent,
    ...
    const preData = component.preSampleData;
