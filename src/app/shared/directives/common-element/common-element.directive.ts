...
@Directive({
  selector: 'a,p,div,span,section,article,h1,h2,h3,h4,h5,h6,b,strong,i,' +
  'body,button,input,dt,dl,ul,li,ol,form,img,label,legend,fieldset,nav,aside,' +
  'header,footer,select,option,table,tr,td,thead,tbody,tfooter,textarea',
